...
This code change the initial strategy. rand(2) --> only 1 positive click at first in order, and ADD the time line channel
Therefore INPUT channel (XYZ Pch Nch Mask TimeLine) 
...
def main(gpu, cfg): 
    ...
    for epoch in range(0, cfg.epochs):
        ...
        if epoch == 0:
            ...
            del pred_list # to recycle the memory
        ...
        del train_loader # to recycle the memory train_loader = None
        # gc.collect()
        is_best = False
        results = None

        if epoch < 10: # There is no sense to validate the model too early
            continue
        ...
        for iters in range(0, 5):
            if iters == 0:
                ...
                del results # to recycle the memory
            ...
            del val_loader # to recycle the memory
        ...
        if val_miou > best_val:
            ...
            with np.printoptions(precision=2, suppress=True):
                logging.info(
                    ...
                    f'\nmious: {val_ious}')
            save_checkpoint(cfg, model, epoch, optimizer, scheduler,
                            additioanl_dict={'MaxIoU': val_miou},
                            is_best=is_best,
                            save_name = cfg.run_name + 'Max_IoU'
                            )
...
# CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/pointmetabase-l-trainApo.yaml
# CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/TiisNet-trainApo.yaml
# CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/TiisNet2-trainApo.yaml

#CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/TiisNet2-trainKT.yaml
#CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/TiisNet2-trainScan.yaml
#CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/TiisNet2-trainSMKT.yaml

#CUDA_VISBLE_DEVICES=0 python examples/interactivesg4/mainFK2.py --cfg cfgs/interactivesg4/TiisNet2-trainScanSeen.yaml
